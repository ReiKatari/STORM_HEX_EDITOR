...
<p align="center">
  <b>Единый командный центр и хаб для всех инструментов линейки STORM.</b>
</p>

[![Version](https://img.shields.io/badge/version-1.0.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_SUITE)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_SUITE)
[![Tech](https://img.shields.io/badge/Tech-Python+%2f+PyQt6+%2f+Suite+Core-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_SUITE)
...
**STORM SUITE** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_SUITE_1.0.0_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM SUITE с созданием ярлыков и регистрацией в системе.
